...
| No `email_verified_at` timestamp | Low      | `is_verified` boolean tells you _if_ but not _when_ — useful for compliance.                                                                                                   |
...
- `discord_configs` duplicates guild/channel/user mapping with _fewer features_ (no filters, no credentials)
...
| Issue                                             | Severity | Description                                                                                                                                                                                                                                             |
| ------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `audit_log` missing `details` JSONB               | **High** | You can see _what_ action happened but not _what changed_. Before/after snapshots are essential for compliance and debugging.                                                                                                                           |
...
_End of Audit. Total findings: 8 Critical, 12 Moderate, 6 Low. Schema is fundamentally sound but needs hardening in security, performance, and billing domains._
