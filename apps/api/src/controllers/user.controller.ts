...
export class UserController {
  ...
  getSeekerProfile = async (
    ...
    try {
      const profile = await seekerProfileQueries.findByUserId(
        userFromRequest(req),
      );
  ...
  getEmployerProfile = async (
    ...
    try {
      const profile = await employerProfileQueries.findByUserId(
        userFromRequest(req),
      );
      res.json({ success: true, data: profile });
    } catch (error) {
  ...
  updateEmployerProfile = async (
    ...
    try {
      ...
      const result = profile
        ...
        : await employerProfileQueries.create(userId, {
  ...
  getSubscription = async (
    ...
    try {
      const subscription = await subscriptionQueries.findByUserId(
        userFromRequest(req),
      );
      res.json({
        success: true,
  ...
  changePassword = async (
    ...
    try {
      ...
      await userQueries.updatePassword(
        userId,
        await bcrypt.hash(new_password, salt),
      );
